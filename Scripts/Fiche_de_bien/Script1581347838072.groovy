...
WebUI.navigateToUrl('https://v2.immo-facile.com/catalog/admin-v2/categories_office.php?action=new_product&pID=31556338')
WebUI.waitForPageLoad(10)
WebUI.delay(5)
...
CustomKeywords.'kms.turing.katalon.plugins.visualtesting.ScreenCapture.takeCuttingScreenshot'('cutting_screen.png',135, 25, FailureHandling.OPTIONAL)
