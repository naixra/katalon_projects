...
def static "tools.getTestingConfig.getOperatingSystem"() {
    (new tools.getTestingConfig()).getOperatingSystem()
}

def static "tools.getTestingConfig.getBrowserAndVersion"() {
    (new tools.getTestingConfig()).getBrowserAndVersion()
}

def static "tools.getTestingConfig.getScreenResolution"() {
    (new tools.getTestingConfig()).getScreenResolution()
}
